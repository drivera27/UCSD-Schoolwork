...
I used Python's `transformers` library to observe how LLMs understand nuances in language such as double negatives (i.e "I didn't see *anything*" vs. "I didn't see *nothing*"). I created 10 minimal pairs to compare how GPT-2 would "react" to each stimuli, which is measured by the model's **surprisal**. 
...
The entire report, as well as all my code, was created using Jupyter Notebook, and can be found [here](https://github.com/drivera27/UCSD-Schoolwork/blob/main/COGS150/COGS150_FinalProject.ipynb).
